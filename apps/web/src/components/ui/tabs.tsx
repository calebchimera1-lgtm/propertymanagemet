...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // Scrolls horizontally rather than wrapping on a phone.
      'inline-flex w-full items-center gap-1 overflow-x-auto rounded-md bg-muted p-1 text-muted-foreground sm:w-auto',
      className,
    )}
    {...props}
  />
